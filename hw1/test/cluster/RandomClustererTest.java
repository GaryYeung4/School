...
public class RandomClustererTest {
    ...
    /**
     * Test of getMaxIterations method, of class RandomClusterer.
     */
       @Test
    public void testGetMaxIterations() {
        ...
        RandomClusterer instance = new RandomClusterer(dataset, 10, 5, true, 3);
        int expResult = 10;
        int result = instance.getMaxIterations();
        assertEquals(expResult, result);
        //Tests if negative values will set iteration count to 1
        instance = new RandomClusterer(dataset, -40, 5, true, 3);
        expResult = 1;
    ...
    /**
     * Test of getUpdateInterval method, of class RandomClusterer.
     */
    @Test
    public void testGetUpdateInterval() {
        ...
        assertEquals(expResult, result);
        //Tests if negative values will set iteration count to 1
        instance = new RandomClusterer(dataset, 10, -5, true, 3);
        expResult = 1;
    ...
    /**
     * Test of tocontinue method, of class RandomClusterer.
     */
    @Test
    public void testTocontinue() {
        ...
        instance = new RandomClusterer(dataset, 10, 5, false, 3);
        expResult = false;
    ...
    public void testGetDataLabels() {
        ...
        instance = new RandomClusterer(dataset, 10, 5, false, 1);
        expResult = 2;
        result = instance.getNumberOfClusters();
        assertEquals(expResult, result);    
        //Tests if label numbers more than 4 are set to 4
        instance = new RandomClusterer(dataset, 10, 5, false, 5);
        expResult = 4;
        result = instance.getNumberOfClusters();
        assertEquals(expResult, result);    
    }
